...
import { type ApiClient, ApiClientError, type MemberRole, type Touch } from '../api'
  ...
  render(
    <ApiProvider value={api}>
      <MemoryRouter initialEntries={['/worlds/w1']}>
        <Routes>
          <Route path="/worlds/:worldId" element={<SessionTouches sessionId="se1" role={role} />} />
        </Routes>
      </MemoryRouter>
    </ApiProvider>,
  )
