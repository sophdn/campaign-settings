    ...
    <div className="wiki-graph-wrap">
      ...
      >
        {graph.edges.map((edge) => {
          ...
          // touch = solid accent (explicit interaction); bracket = dashed (parsed
          // mention); description = plain entity↔entity link.
          const stroke = edge.type === 'touch' ? 'var(--color-accent)' : 'var(--color-border)'
