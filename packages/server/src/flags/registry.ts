...
export interface FeatureFlags {
   ...
   *
   * It is no longer the ONLY thing that closes it: `demoRequestAllowed` refuses
   * the demo principal the whole `/api/account/*` family whatever this flag
   * says, and whatever the method. The flag is a deployment preference; the
   * principal check is the guarantee.
   */
