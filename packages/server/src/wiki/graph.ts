...
/**
 * Edge provenance: an entity↔entity `description` link, or an entity↔session
 * link that is either a `touch` (an explicit EntityTouch interaction) or a
 * `bracket` (a `[[mention]]` parsed from the session's captured_text).
 */
