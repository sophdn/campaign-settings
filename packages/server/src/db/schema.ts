...
export type CultureLanguageRole = 'native' | 'secondary' | 'liturgical'
export type EntityLanguageRole = 'native' | 'secondary' | 'trade'
...
// ── junctions ──────────────────────────────────────────────────────────────
export interface CultureLanguagesTable {
  world_id: string
  culture_id: string
  language_id: string
  role: CultureLanguageRole
}

export interface CultureMagicSystemsTable {
  world_id: string
  culture_id: string
  magic_system_id: string
}

export interface CulturePantheonsTable {
  world_id: string
  culture_id: string
  pantheon_id: string
}

export interface NpcLanguagesTable {
  world_id: string
  npc_id: string
  language_id: string
  role: EntityLanguageRole
}

export interface NpcMagicSystemsTable {
  world_id: string
  npc_id: string
  magic_system_id: string
}

export interface PcLanguagesTable {
  world_id: string
  pc_id: string
  language_id: string
  role: EntityLanguageRole
...
export interface PcMagicSystemsTable {
  world_id: string
  pc_id: string
  magic_system_id: string
}

export interface SettlementLanguagesTable {
  world_id: string
...
export interface ResourceLocationsTable {
  world_id: string
  resource_id: string
  location_id: string
  notes: Generated<string>
...
export interface PlayerCharactersTable {
  id: string
  world_id: string
  owner_id: string
  name: string
...
export interface Database {
  ...
  culture_languages: CultureLanguagesTable
  culture_magic_systems: CultureMagicSystemsTable
  culture_pantheons: CulturePantheonsTable
  npc_languages: NpcLanguagesTable
  npc_magic_systems: NpcMagicSystemsTable
  pc_languages: PcLanguagesTable
  pc_magic_systems: PcMagicSystemsTable
  settlement_languages: SettlementLanguagesTable
  ...
  resource_locations: ResourceLocationsTable
  ...
  player_characters: PlayerCharactersTable
